...
def parse_opt():
    parser = argparse.ArgumentParser(description="VOC Dataset Split & Check")

    parser.add_argument('--voc_path', type=str, default='VOCdevkit',
                        help='Dataset root path')
    parser.add_argument('--trainval_percent', type=float, default=1.0,
                        help='Ratio of train+val vs test (default: 1.0 means no test set)')
    parser.add_argument('--train_percent', type=float, default=0.9,
                        help='Ratio of train inside trainval (default: 0.9)')
...
if __name__ == "__main__":
    ...
    segfilepath = os.path.join(opt.voc_path, 'VOC2007/SegmentationClass')
    saveBasePath = os.path.join(opt.voc_path, 'VOC2007/ImageSets/Segmentation')
    ...
    trainval = random.sample(seg_idxs, tv)
